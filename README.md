...
TypeScript / REST API(Open API) / Stoplight Studio / PlanetScale / Node.js / Express / Prisma / Google Cloud Storage(GCS) / PostgreSQL(途中まで) / MySQL(PlanetScaleへ移行したため) / PlanetScale / GCP / Cloud Run
